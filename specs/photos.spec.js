...
describe('Photos', () => {
    ...
    it('should add a new photo', () => {
      return chakram
        ...
        .then((response) => {
          ...
          expect(todo).to.have.json('data.albumId', 101);
  ...
  describe('Update', () => {
    it('should update existing photo with given data', () => {
      const response = chakram.put(api.url('photos/1'), {
        albumId: 1,
        id: 1,
        title:
          'updatedPhoto',
      ...
      return response.then((data) => {
        const todo = chakram.get(api.url('photos/1'));
  ...
  describe('Delete', () => {
    it('should delete photo by ID', () => {
      ...
      expect(response).to.have.status(200);
      return response.then(data => {
        const user = chakram.get(api.url('photos/500'));
